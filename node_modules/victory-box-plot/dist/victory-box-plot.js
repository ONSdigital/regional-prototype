...
function getStringsFromData(props, axis) {
  ...
  var accessor = __WEBPACK_IMPORTED_MODULE_12__helpers__["a" /* default */].createAccessor(key);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_lodash_isNil__ = __webpack_require__(/*! lodash/isNil */ 85);
...
/* harmony default export */ __webpack_exports__["a"] = (Object(__WEBPACK_IMPORTED_MODULE_4_victory_core__["o" /* addEvents */])(VictoryBoxPlot));
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10_react_fast_compare__ = __webpack_require__(/*! react-fast-compare */ 14);
    ...
    function (_WrappedComponent) {
      ...
      _createClass(addEvents, [{
        ...
        value: function componentDidUpdate() {
          ...
          if (!__WEBPACK_IMPORTED_MODULE_10_react_fast_compare___default()(this.externalMutations, externalMutations)) {
        ...
        value: function renderContinuousData(props) {
          ...
          var labelComponents = dataKeys.reduce(function (memo, key) {
            var labelProps = _this3.getComponentProps(labelComponent, "labels", key);
        ...
        value: function renderData(props) {
          ...
          var dataComponents = this.dataKeys.reduce(function (validDataComponents, _dataKey, index) {
            var dataProps = _this4.getComponentProps(dataComponent, "data", index);
          ...
          var labelComponents = this.dataKeys.map(function (_dataKey, index) {
            var labelProps = _this4.getComponentProps(labelComponent, "labels", index);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_lodash_isNaN__ = __webpack_require__(/*! lodash/isNaN */ 345);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_lodash_groupBy__ = __webpack_require__(/*! lodash/groupBy */ 148);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_lodash_groupBy___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2_lodash_groupBy__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_lodash_uniq__ = __webpack_require__(/*! lodash/uniq */ 27);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_lodash_orderBy__ = __webpack_require__(/*! lodash/orderBy */ 33);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_lodash_orderBy___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_6_lodash_orderBy__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7_victory_core__ = __webpack_require__(/*! victory-core */ 87);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8_d3_array__ = __webpack_require__(/*! d3-array */ 8);
...
var checkProcessedData = function (props, data) {
  ...
  if (hasQuartileAttributes) {
    ...
    if (!__WEBPACK_IMPORTED_MODULE_3_lodash_uniq___default()(values).length === values.length) {
...
var nanToNull = function (val) {
  return __WEBPACK_IMPORTED_MODULE_0_lodash_isNaN___default()(val) ? null : val;
};
...
var getSummaryStatistics = function (data, horizontal) {
  ...
  var quartiles = {
    _q1: nanToNull(Object(__WEBPACK_IMPORTED_MODULE_8_d3_array__["f" /* quantile */])(dependentVars, 0.25)),
    // eslint-disable-line no-magic-numbers
    _q3: nanToNull(Object(__WEBPACK_IMPORTED_MODULE_8_d3_array__["f" /* quantile */])(dependentVars, 0.75)),
    // eslint-disable-line no-magic-numbers
    _min: nanToNull(Object(__WEBPACK_IMPORTED_MODULE_8_d3_array__["e" /* min */])(dependentVars)),
    _median: nanToNull(Object(__WEBPACK_IMPORTED_MODULE_8_d3_array__["f" /* quantile */])(dependentVars, 0.5)),
    _max: nanToNull(Object(__WEBPACK_IMPORTED_MODULE_8_d3_array__["d" /* max */])(dependentVars))
  };
  return horizontal ? __WEBPACK_IMPORTED_MODULE_4_lodash_assign___default()({}, quartiles, {
    _y: data[0]._y
  }) : __WEBPACK_IMPORTED_MODULE_4_lodash_assign___default()({}, quartiles, {
    _x: data[0]._x
  });
};
    ...
    if (arrayX && arrayY) {
      ...
      return data.map(function (datum) {
        var dataArray = datum[sortKey].map(function (d) {
          return __WEBPACK_IMPORTED_MODULE_4_lodash_assign___default()({}, datum, _defineProperty({}, sortKey, d));
        });

        var sortedData = __WEBPACK_IMPORTED_MODULE_6_lodash_orderBy___default()(dataArray, sortKey);
      ...
      var groupedData = __WEBPACK_IMPORTED_MODULE_2_lodash_groupBy___default()(data, groupKey);

      return __WEBPACK_IMPORTED_MODULE_1_lodash_keys___default()(groupedData).map(function (key) {
        var datum = groupedData[key];

        var sortedData = __WEBPACK_IMPORTED_MODULE_6_lodash_orderBy___default()(datum, sortKey);
...
var getData = function (props) {
  ...
  var formattedData = __WEBPACK_IMPORTED_MODULE_7_victory_core__["d" /* Data */].formatData(props.data, props, accessorTypes);
  return formattedData.length ? processData(props, formattedData) : [];
};

var reduceDataset = function (dataset, props, axis) {
  var minDomain = __WEBPACK_IMPORTED_MODULE_7_victory_core__["f" /* Domain */].getMinFromProps(props, axis);
  var maxDomain = __WEBPACK_IMPORTED_MODULE_7_victory_core__["f" /* Domain */].getMaxFromProps(props, axis);
  ...
  return __WEBPACK_IMPORTED_MODULE_7_victory_core__["f" /* Domain */].getDomainFromMinMax(minData, maxData);
};
...
var getDomainFromData = function (props, axis) {
  ...
  if (dataset.length < 1) {
    var scaleDomain = __WEBPACK_IMPORTED_MODULE_7_victory_core__["j" /* Scale */].getBaseScale(props, axis).domain();
    var min = minDomain !== undefined ? minDomain : __WEBPACK_IMPORTED_MODULE_7_victory_core__["b" /* Collection */].getMinValue(scaleDomain);
    var max = maxDomain !== undefined ? maxDomain : __WEBPACK_IMPORTED_MODULE_7_victory_core__["b" /* Collection */].getMaxValue(scaleDomain);
    return __WEBPACK_IMPORTED_MODULE_7_victory_core__["f" /* Domain */].getDomainFromMinMax(min, max);
  }
...
var getDomain = function (props, axis) {
  return __WEBPACK_IMPORTED_MODULE_7_victory_core__["f" /* Domain */].createDomainFunction(getDomainFromData)(props, axis);
};
...
var getStyles = function (props, styleObject) {
  ...
  var labelStyles = __WEBPACK_IMPORTED_MODULE_5_lodash_defaults___default()({}, style.labels, styleObject.labels);

  var boxStyles = __WEBPACK_IMPORTED_MODULE_5_lodash_defaults___default()({}, style.boxes, styleObject.boxes);

  var whiskerStyles = __WEBPACK_IMPORTED_MODULE_5_lodash_defaults___default()({}, style.whiskers, styleObject.whiskers);

  return {
    boxes: boxStyles,
    labels: labelStyles,
    parent: __WEBPACK_IMPORTED_MODULE_5_lodash_defaults___default()({}, style.parent, styleObject.parent, parentStyles),
    max: __WEBPACK_IMPORTED_MODULE_5_lodash_defaults___default()({}, style.max, styleObject.max, whiskerStyles),
    maxLabels: __WEBPACK_IMPORTED_MODULE_5_lodash_defaults___default()({}, style.maxLabels, styleObject.maxlabels, labelStyles),
    median: __WEBPACK_IMPORTED_MODULE_5_lodash_defaults___default()({}, style.median, styleObject.median, whiskerStyles),
    medianLabels: __WEBPACK_IMPORTED_MODULE_5_lodash_defaults___default()({}, style.medianLabels, styleObject.medianlabels, labelStyles),
    min: __WEBPACK_IMPORTED_MODULE_5_lodash_defaults___default()({}, style.min, styleObject.min, whiskerStyles),
    minLabels: __WEBPACK_IMPORTED_MODULE_5_lodash_defaults___default()({}, style.minLabels, styleObject.minlabels, labelStyles),
    q1: __WEBPACK_IMPORTED_MODULE_5_lodash_defaults___default()({}, style.q1, styleObject.q1, boxStyles),
    q1Labels: __WEBPACK_IMPORTED_MODULE_5_lodash_defaults___default()({}, style.q1Labels, styleObject.q1labels, labelStyles),
    q3: __WEBPACK_IMPORTED_MODULE_5_lodash_defaults___default()({}, style.q3, styleObject.q3, boxStyles),
    q3Labels: __WEBPACK_IMPORTED_MODULE_5_lodash_defaults___default()({}, style.q3Labels, styleObject.q3labels, labelStyles),
...
var getCalculatedValues = function (props) {
  ...
  var range = {
    x: __WEBPACK_IMPORTED_MODULE_7_victory_core__["g" /* Helpers */].getRange(props, "x"),
    y: __WEBPACK_IMPORTED_MODULE_7_victory_core__["g" /* Helpers */].getRange(props, "y")
  };
  var domain = {
    x: getDomain(props, "x"),
    y: getDomain(props, "y")
  ...
  var scale = {
    x: __WEBPACK_IMPORTED_MODULE_7_victory_core__["j" /* Scale */].getBaseScale(props, "x").domain(domain.x).range(range.x),
    y: __WEBPACK_IMPORTED_MODULE_7_victory_core__["j" /* Scale */].getBaseScale(props, "y").domain(domain.y).range(range.y)
  };
...
var getBaseProps = function (props, fallbackProps) {
  var modifiedProps = __WEBPACK_IMPORTED_MODULE_7_victory_core__["g" /* Helpers */].modifyProps(props, fallbackProps, "boxplot");
  ...
  return data.reduce(function (acc, datum, index) {
    ...
    var dataProps = __WEBPACK_IMPORTED_MODULE_4_lodash_assign___default()({
      index: index,
      datum: datum,
      positions: positions
    }, props);
